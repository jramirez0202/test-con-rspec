class AssembliesController < ApplicationController
  ...
  # GET /assemblies.json
  def index
    @assemblies = Assembly.all.includes(:wine, :strain)
  end
  ...
  private
    ...
    # Only allow a list of trusted parameters through. puse el strain_ids
    def assembly_params
      params.require(:assembly).permit(:name, :percent, :wine_id, :strain_id, :assembly_id, strain_ids: [])
    end
end
